        ...
        <View style={styles.reviewBagContainer}>
          ...
          <View style={styles.dataInContainer}>
            ...
            <View style={styles.inputWrapper}>
              <View style={styles.flagImgBox}>
                <Image source={UsaFlag} style={styles.flagImg} />
              </View>
          ...
          <View style={styles.btnAddBox}>
            <TouchableOpacity
              ...
              <Text style={styles.goBtnStyleTxt}>Add</Text>
            </TouchableOpacity>
          </View>
        </View>
        <HintHeaderBg text={'Add at least 6 words to start your custom bag'} />
        ...
        <View style={styles.reviewBagContainer}>
          ...
          <View style={styles.btnWrapper}>
            <TouchableOpacity
              ...
              disabled={
                customWordsBagRoad.length === 0 && customBagArray.length === 0
              }
              onPress={() => {
                goToLoop();
              }}>
              <Text style={styles.goBtnStyleTxt}>
                ...
                {loop[0].stepOfCustomWordsBag === 0
                  ? loop[0].isCustomDiscover < 3
                    ? 'Start' + loop[0].isCustomDiscover
                    : 'Review' + loop[0].isCustomDiscover
                  : 'Continue' + loop[0].isCustomDiscover}
              </Text>
            </TouchableOpacity>
            {loop[0].isCustomDiscover === 3 ? (
              <TouchableOpacity
